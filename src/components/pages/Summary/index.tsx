    ...
    <MainLayout>
      ...
      <Stack w="100%" mb="32px" px="24px">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <Stack w="100%" gap={["24px", "24px", "32px", "32px"]}>
              <Card
                  ...
                  {data?.status === "draft" && (
                    <Flex w="100%" mt="40px" justifyContent="end">
                      <Button
                        ...
                        fontWeight={500}
                        fontSize={16}
                        w={["160px", "160px", "236px", "236px"]}
                        h={["40px", "40px", "56px", "56px"]}
                        borderRadius={["50px", "50px", "34px", "34px"]}
                        type="submit"
                      >
                        Submit
                      </Button>

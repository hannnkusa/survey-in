          ...
          >
            ...
            <CardBody p={0} mt="16px">
              ...
              <Text color="#6E6E6E" fontWeight={400} fontSize={"sm"} mt="8px">
                Questionnaire will be proceed after you upload the payment proof
                (screenshot of successful payment). Make sure you fill payer’s
                name with name doing the transaction.
              </Text>
              <Flex mt="40px" direction="column">
                <Heading size="sm" fontWeight={600}>
                  Payment proof
